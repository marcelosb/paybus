...
public class PagamentoRecyclerViewAdapter extends RecyclerView.Adapter<PagamentoRecyclerViewAdapter.ViewHolderAluno>   {

    List<Aluno> listaDeAlunos;
    Context context;

    public PagamentoRecyclerViewAdapter(List<Aluno> listaDeAlunos, Context context) {
    ...
    @NonNull
    @Override
    public PagamentoRecyclerViewAdapter.ViewHolderAluno onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final PagamentoRecyclerViewAdapter.ViewHolderAluno holder, final int position) {
